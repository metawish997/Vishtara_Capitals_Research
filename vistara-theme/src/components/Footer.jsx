                  ...
                  <div className="row">
                     ...
                     <div className="col-xl-3 col-md-6 col-sm-6">
                          <div className="tp-footer-widget umb-90">
                             <h4 className="tp-footer-widget-title">DISCLOSURES &amp; CHARTER</h4>
                             <div className="tp-footer-widget-menu">
                                <ul>
                                   <li><Link className="tp-line-anim" to="/sebi-disclosures">SEBI Discloser</Link></li>
                       ...
                       <div className="col-xl-3 col-md-6 col-sm-6">
                          <div className="tp-footer-widget umb-90">
                             <h4 className="tp-footer-widget-title">POLICIES &amp; LEGAL</h4>
                             <div className="tp-footer-widget-menu">
                                <ul>
                      ...
                      <div className="col-xl-3 col-md-4 col-sm-6">
                         <div className="tp-footer-widget umb-60">
                            <h4 className="tp-footer-widget-title">LOCATION</h4>
                  ...
                  <hr style={{ borderColor: "rgba(34, 47, 48, 0.15)", margin: "40px 0 30px 0" }} />
                   <div className="row">
                      <div className="col-12">
                         <div style={{ color: "#6C7A7C", lineHeight: "1.7", marginBottom: "25px" }}>
                            <h5 style={{ fontSize: "15px", fontWeight: "700", marginBottom: "8px", color: "var(--tp-theme-secondary)", textTransform: "uppercase", letterSpacing: "0.5px" }}>Accessibility Disclosure</h5>
                         ...
                         <div style={{ color: "#6C7A7C", lineHeight: "1.7", marginBottom: "20px" }}>
                            <h5 style={{ fontSize: "15px", fontWeight: "700", marginBottom: "8px", color: "var(--tp-theme-secondary)", textTransform: "uppercase", letterSpacing: "0.5px" }}>Regulatory Disclaimer</h5>
