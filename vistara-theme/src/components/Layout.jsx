      ...
      <div className="tp-offcanvas-wrapper">
         <div className="tp-offcanvas-top d-flex align-items-center justify-content-between">
            <div className="tp-offcanvas-logo">
               <a href="index.html">
                  <img className="logo-1" style={{width: "120px"}} src="/assets/img/logo/logo.png" alt="" />
               </a>
            </div>
               ...
               <div className="row gx-2">
                  <div className="col-md-4 col-3">
                     <div className="tp-offcanvas-gallery-img fix">
                        <a className="popup-image" href="assets/img/blog/recent-thumb-1.jpg">
                  ...
                  <div className="col-md-4 col-3">
                     <div className="tp-offcanvas-gallery-img fix">
                        <a className="popup-image" href="assets/img/blog/recent-thumb-2.jpg">
                  ...
                  <div className="col-md-4 col-3">
                     <div className="tp-offcanvas-gallery-img fix">
                        <a className="popup-image" href="assets/img/blog/recent-thumb-3.jpg">
   ...
   <div className="tp-search-area p-relative">
      <div className="tp-search-wrapper">
         <div className="tp-search-close">
            <button type="button" className="tp-search-close-btn">
               <svg width="37" height="38" viewBox="0 0 37 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9.19141 9.80762L27.5762 28.1924" stroke="currentColor" strokeWidth="1.5"
            ...
            <div className="row justify-content-center">
               <div className="col-lg-8">
                  <div className="tp-search-input p-relative umb-60">
                     ...
                     <button type="submit" className="tp-search-input-btn">
