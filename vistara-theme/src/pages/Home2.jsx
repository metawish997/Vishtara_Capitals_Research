...
export default function Home2() {
  ...
  useEffect(() => {
    document.body.classList.add("theme-finances-opposite");
    document.body.classList.remove("theme-finances");
    return () => {
      document.body.classList.remove("theme-finances-opposite");
      document.body.classList.add("theme-finances");
    };
  }, []);
  ...
  return (
    <main className="theme-finances-opposite">
               ...
               <svg xmlns="http://www.w3.org/2000/svg" width="747" height="600" viewBox="0 0 747 600" fill="none"
                  ...
                  <defs>
                     <linearGradient id="hero-line-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stopColor="rgb(36, 63, 99)" />
                        <stop offset="60%" stopColor="rgb(50, 78, 115)" />
                        <stop offset="100%" stopColor="rgb(36, 63, 99)" />
                     </linearGradient>
                  </defs>
                  <path
                     ...
                     stroke="url(#hero-line-gradient)" strokeWidth="20" strokeLinecap="round"
                     ...
                     <div className="tp-fi-hero-wrapper z-index-1">
                        <div className="tp-fi-hero-content upb-145">
                           <h3 className="tp-fi-hero-title" data-text-split data-letters-fade-in>Empowering Decisions <br />
                              Through Research.</h3>
                           <div className="tp-fi-hero-trust umt-20 umb-20 tp-fade-anim" style={{fontWeight: 700, color: "var(--tp-theme-primary)", letterSpacing: "2px", fontSize: "12px", textTransform: "uppercase"}}>
                         ...
                         <div className="tp-fi-hero-bottom">
                             <div className="tp-fi-hero-btn umb-20 tp-fade-anim" data-delay=".5">
                            ...
                            <div className="tp-fi-hero-contact tp-fade-anim">
         ...
         <div className="tp-fi-stories-ptb tp-sec-line upt-80 upb-50">
            <div className="container">
               <div className="row">
                  <div className="col-xl-3 col-lg-4 col-md-6">
                     <div className="tp-fi-stories-content umb-30 tp-fade-anim">
                  ...
                  <div className="col-xl-3 col-lg-4 col-md-6">
                     <div className="tp-fi-stories-item umb-30 tp-fade-anim" data-delay=".7" style={{backgroundColor: "#F7F7F5"}}>
                        <div className="tp-fi-stories-item-thumb upb-200">
                           <img src="/assets/img/finance/stories/user.png" alt="" />
                        </div>
                        <div className="tp-fi-stories-item-content style-2">
            ...
            <div className="container">
               <div className="row align-items-center">
                  <div className="col-lg-6">
                     <div className="tp-fi-about-content umb-30">
                  ...
                  <div className="col-lg-6">
                     <div className="tp-fi-about-thumb-wrap p-relative text-xl-end umb-30">
                        <img src="/assets/img/finance/about/thumb-1.jpg" alt="" />
         ...
         <div className="tp-fi-banner-ptb">
          ...
          <div className="tp-fi-text-ptb upt-20 upb-20" style={{background: "linear-gradient(160deg, rgb(36, 63, 99) 0%, rgb(50, 78, 115) 60%, rgb(36, 63, 99) 100%)"}}>
               ...
               <div className="row">
                  <div className="col-lg-6">
                     <div className="tp-fi-value-thumb-wrapper p-relative  umb-30 umt-30">
                        ...
                        <div className="tp-fi-value-graph p-relative tp-fade-anim" style={{
                            background: "linear-gradient(160deg, rgb(36, 63, 99) 0%, rgb(50, 78, 115) 60%, rgb(36, 63, 99) 100%)",
                               ...
                               <span>
                                  <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewBox="0 0 15 14"
                                     ...
                                     <path
                                        ...
                                        stroke="#ffffff" strokeMiterlimit="10" strokeLinecap="round"
                                        strokeLinejoin="round" />
                                     <path
                            ...
                            <h3 className="tp-fi-value-graph-title" style={{color: "#ffffff"}}>Risk-to-Reward</h3>
                            <span className="tp-fi-value-graph-date" style={{color: "#ffffff"}}>Tactical Trading</span>
                            <div className="tp-fi-value-graph-count d-flex justify-content-between">
                               <span style={{color: "#ffffff"}}>1:2+</span>
                               <p style={{color: "#ffffff"}}>Average risk to <br /> reward ratio</p>
                            </div>
            ...
            <div className="container">
               <div className="row align-items-center">
                  <div className="col-lg-5 tp-fade-anim" data-delay=".3">
                     <div className="tp-fi-team-item umb-30 p-relative"
                        ...
                        <div className="tp-fi-team-item-content" style={{transform: "none"}}>
                           <h3 className="tp-fi-team-item-title" style={isTeamHovered ? {color: "#ffffff"} : {}}>Anujay Chouhan</h3>
                           <span style={isTeamHovered ? {color: "#ffffff"} : {}}>Lead Research Analyst & Founder</span>
                        </div>
                     </div>
                  </div>
