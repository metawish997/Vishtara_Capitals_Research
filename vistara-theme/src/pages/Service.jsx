...
export default function Service() {
  return (
    <main>
         ...
         <div className="tp-cn-counter-ptb tp-sec-ptb fix upt-140 upb-110">
            <div className="container">
               <div className="row">
                  ...
                  <div className="col-lg-6">
                     <div className="tp-cn-counter-wrapper umb-30">
                        <div className="tp-cn-counter-item">
                           <span className="tp-cn-counter-title">Active subscribers</span>
                           <h2 className="tp-cn-counter-number"><span className="purecounter">1000</span><span className="tp-cn-counter-suffix">+</span></h2>
                        </div>

                        <div className="tp-cn-counter-item">
                           <span className="tp-cn-counter-title">SEBI Registered</span>
                           <h2 className="tp-cn-counter-number"><span className="purecounter">100</span><span className="tp-cn-counter-suffix">% compliant</span></h2>
                        </div>

                        <div className="tp-cn-counter-item">
                           <span className="tp-cn-counter-title">Market research</span>
                           <h2 className="tp-cn-counter-number"><span className="purecounter">5</span><span className="tp-cn-counter-suffix">+ years</span></h2>
                        </div>

                        <div className="tp-cn-counter-item">
                           <span className="tp-cn-counter-title">Accuracy focus</span>
                           <h2 className="tp-cn-counter-number"><span className="tp-cn-counter-prefix">&gt;</span><span className="purecounter">90</span><span className="tp-cn-counter-suffix">% target setups</span></h2>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div className="container">
               <div className="row">
                  <div className="col-lg-12">
                     <div className="tp-cn-philoshopy-heading umb-70 z-index-1">
                        <span className="tp-section-cn-sub tp-fade-anim" style={{ color: "#8FA5C2" }}>Vishtara philosophy</span>
               ...
               <div className="row">
                  <div className="col-lg-3 col-sm-6">
                     <div className="tp-cn-philoshopy-item text-center umb-30" style={{ borderColor: "rgba(255,255,255,0.1)" }}>
                        <div className="tp-cn-philoshopy-item-content">
                           ...
                           <h3 className="tp-cn-philoshopy-item-title" style={{ color: "#ffffff" }}>
                              Deep market expertise
                           </h3>
                        </div>
                        <div className="tp-cn-philoshopy-item-text">
                           <p style={{ color: "#8FA5C2" }}>
