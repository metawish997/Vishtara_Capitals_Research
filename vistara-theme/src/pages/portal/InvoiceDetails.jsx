...
export default function InvoiceDetails() {
    ...
    useEffect(() => {
        if (!invoice) {
            // If accessed directly without state, redirect back to invoices
    ...
    return (
        <div style={{ fontFamily: "'Inter', sans-serif", color: "#1b2c42", paddingBottom: "40px", maxWidth: "900px", margin: "0 auto" }}>
            ...
            >
                ...
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "40px" }}>
                    <div>
                        ...
                        <div style={{ fontWeight: "700", fontSize: "15px", color: "#0f172a" }}>{user?.name || "Client"}</div>
                        <div style={{ fontSize: "13px", color: "#475569", marginTop: "4px" }}>{user?.email}</div>
                        <div style={{ fontSize: "13px", color: "#475569", marginTop: "2px" }}>{user?.phone}</div>
                    </div>
                    <div style={{ textAlign: "right" }}>
