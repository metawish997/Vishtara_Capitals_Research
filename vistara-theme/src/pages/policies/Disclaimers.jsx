    ...
    <PolicyLayout title="Disclaimers" description="Vishtara Capital Research Policy Document">
      <div className="policy-content-wrapper">
                ...
                <div id="general" className="mb-8 scroll-mt-28">
                    ...
                    <div className="text-[15px] text-slate-700 dark:text-slate-400 leading-relaxed space-y-4">
                ...
                <div id="ownership" className="mb-8 scroll-mt-28">
                    ...
                    <ul className="space-y-4 text-[15px] text-slate-700 dark:text-slate-400 list-disc pl-5">
                ...
                <div id="definitions" className="mb-8 scroll-mt-28">
                    ...
                    <div className="space-y-4 text-[15px] font-medium">
                        <div><span className="text-xs uppercase font-black text-[#0939a4] dark:text-[#FBB040] bg-[#0939a4]/5 dark:bg-[#FBB040]/10 px-2 py-0.5 rounded mr-2">Buy</span> <span className="text-slate-700 dark:text-slate-400">Triggers immediately at current market parameters or within noted bands.</span></div>
                        <div><span className="text-xs uppercase font-black text-[#0939a4] dark:text-[#FBB040] bg-[#0939a4]/5 dark:bg-[#FBB040]/10 px-2 py-0.5 rounded mr-2">Stop Loss</span> <span className="text-slate-700 dark:text-slate-400">Strict safety close boundary parameter to shield against volatile market movements. Must be monitored near trading session market close.</span></div>
                        <div><span className="text-xs uppercase font-black text-[#0939a4] dark:text-[#FBB040] bg-[#0939a4]/5 dark:bg-[#FBB040]/10 px-2 py-0.5 rounded mr-2">Add / Accumulate</span> <span className="text-slate-700 dark:text-slate-400">Gradual localized scaling of investment quantities on market price retracements.</span></div>
                        <div><span className="text-xs uppercase font-black text-[#0939a4] dark:text-[#FBB040] bg-[#0939a4]/5 dark:bg-[#FBB040]/10 px-2 py-0.5 rounded mr-2">Hold</span> <span className="text-slate-700 dark:text-slate-400">Preserve existing positioning values when targets or stop-losses have not been breached.</span></div>
                    </div>
                </div>
